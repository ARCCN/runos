...
foreach(header IN LISTS PUBLIC_HEADERS)
    ...
    if (NOT EXISTS "${CMAKE_CURRENT_BINARY_DIR}/headers/${directory}/${filename}.cc")
        file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/headers/${directory}/${filename}.cc" "
...
int main() { }
    ...
    add_executable(test.header.${target}
        EXCLUDE_FROM_ALL
        "${CMAKE_CURRENT_BINARY_DIR}/headers/${directory}/${filename}.cc"
    )
